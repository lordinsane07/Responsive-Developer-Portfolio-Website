...
const skillIconMap: Record<string, React.ReactNode> = {
    ...
    "Node.js 18+": <SiNodedotjs size={20} />,
    "Express.js": <SiExpress size={20} />,
    "Redis": <SiRedis size={20} />,
    "WebRTC": <SiWebrtc size={20} />,
    "Flutter 3.13+": <SiFlutter size={20} />,
    "Bloc": <TbBrain size={20} />,
    "Riverpod": <TbPlug size={20} />,
    "Hive": <SiHive size={20} />,
    "SQLite/SQLCipher": <SiSqlite size={20} />,
    "FCM": <TbBell size={20} />,
    ...
    "OAuth 2.0": <TbBrandOauth size={20} />,
